...
contract DEXpair is IDEXpair {
  ...
  struct Client {
	...
	function createDepositWallet(address rootAddr) public pure alwaysAccept returns (bool createStatus) {
		...
		TvmCell body = tvm.encodeBody(IRootTokenContract(creator).deployEmptyWallet, 0x0000000a, 0, walletId, ownerUINT, 10000);	//	10000 
		creator.transfer({value:26000000, bounce:false, body:body});	//	26000000	
		createStatus = true;
	}
	...
	function connect() public alwaysAccept override functionID(0x00000005) {
		...
		dexclient.transfer({value:5000000, body:body});	//10000000	50000000
	...
	function setPairDepositWallet(address value0) public override alwaysAccept functionID(0x0000000a){
		...
		address wallet = value0;
			if (root == rootA){
				...
				dexclient.transfer({value:4500000, body:body});	//20000000	4200000	4500000
			} else if (root == rootB){
				...
				dexclient.transfer({value:4500000, body:body});	//20000000	4300000	4600000
			}
	}
	...
	function askBalancePairWallets() public view checkOwnerAndAccept {
		...
		transmitterA.transfer({value:20000000, body:bodyA});	//20000000
		transmitterB.transfer({value:20000000, body:bodyB});	//20000000
	}
