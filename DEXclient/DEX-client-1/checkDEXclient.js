  ...
  try{
    ...
    const params = {
      ...
      message_encode_params: {
        ...
        call_set: {
          function_name: 'askPairWalletsBalance',
          input: {
      ...
      console.log('Your askPairWalletsBalance proceed. Tx id: ', response.transaction.id);
      console.log('Your askPairWalletsBalance output: ', response.decoded.output);
