...
const fs = require('fs');
const pathJson = './DEXpairContractWTON-USDT.json';
const pathGiverJson = './GiverContractNTD.json';
const giver = require('./GiverContract.js');
const giverabi = giver.package.abi;
const rootTokenA = "0:bc865dc0b225ec75e158a2e3f862ce6a2398f733930de3fc626643dfdacfb798";
const rootTokenB = "0:b7b17288b1e1c1166797fc40f6329aa598ef720176738769f79fa49c87f50feb";
