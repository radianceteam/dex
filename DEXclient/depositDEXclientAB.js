...
const qtyTokenA = 250000;//specify qty of tokens
const qtyTokenB = 500000;//specify qty of tokens
...
async function main(client) {
  try{
    ...
    const params = {
      ...
      console.log('Your makeABdepositToPair proceed. Tx id: ', response.transaction.id);
      console.log('Your makeABdepositToPair output: ', response.decoded.output);
