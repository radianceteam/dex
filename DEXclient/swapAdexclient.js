...
const qtyTokenA = 1100;//specify qty of tokens
...
async function main(client) {
  try{
    ...
    const params = {
      ...
      console.log('Your processSwapA proceed. Tx id: ', response.transaction.id);
      console.log('Your processSwapA output: ', response.decoded.output);
