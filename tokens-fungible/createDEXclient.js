  ...
  try{
    ...
    const params = {
      ...
      message_encode_params: {
        ...
        call_set: {
          function_name: 'createPairWallets',
          input: {
      ...
      console.log('Your createPairWallets proceed. Tx id: ', response.transaction.id);
      console.log('Your createPairWallets output: ', response.decoded.output);
