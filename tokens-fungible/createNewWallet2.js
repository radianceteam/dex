...
async function main(client) {
  try{
    ...
    const params = {
      ...
      console.log('Your createNewWallet proceed. Tx id: ', response.transaction.id);
      console.log('Your createNewWallet output: ', response.decoded.output);
