  ...
  try{
    ...
    const params = {
      ...
      message_encode_params: {
        ...
        call_set: {
          function_name: 'recreatePairWallets',
          input: {
      ...
      console.log('Your recreatePairWallets proceed. Tx id: ', response.transaction.id);
      console.log('Your recreatePairWallets output: ', response.decoded.output);
