  ...
  try{
    ...
    const params = {
      ...
      message_encode_params: {
        ...
        call_set: {
          function_name: 'resetPairWallets',
          input: {
      ...
      console.log('Your resetPairWallets proceed. Tx id: ', response.transaction.id);
      console.log('Your resetPairWallets output: ', response.decoded.output);
